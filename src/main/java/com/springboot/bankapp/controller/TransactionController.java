...
public class TransactionController 
{
	...
	public Transaction doDeposit(Principal principal, @PathVariable("amount") double amount) {
		...
		//step-2:
		transactionService.depositeAmount(accountNumber, amount);
	...
	public void getCustomer(Principal principal)
	{
		/*
		 * For edit 2 api calls from UI
		 * 
		 * API 1: when screen is shown
		 * Before this API call GetById of customer()
		 * populate edit from with existing customer details
		 * 
		 * API 2: After edit button is pressed
		 * 
		 * step 1:
